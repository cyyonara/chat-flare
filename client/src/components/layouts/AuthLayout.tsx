            ...
            <div className="flex max-w-[900px] flex-1 flex-col items-center justify-center gap-y-8">
               ...
               <div>
                  ...
                  <p>
                     ...
                     Nesciunt pariatur veritatis omnis debitis quidem distinctio
                     ad vitae nemo, hic sed fuga assumenda, vero dolorum iure
                     dolor rem. Impedit pariatur labore officia quasi, minus ex
                     totam quia perspiciatis magni ipsa molestias quibusdam
                     maxime consequuntur provident. Labore impedit fugiat,
                     cumque molestias nesciunt ullam placeat quam minima
                     repudiandae facilis quae optio voluptatum, aut cum
                     architecto? Incidunt, harum animi! Quis itaque tempore
                     nesciunt perspiciatis praesentium doloribus omnis accusamus
                     quod commodi,
                  </p>
               </div>
            </div>
