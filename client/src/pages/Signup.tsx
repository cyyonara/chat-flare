...
export default function Signup({}: IProps) {
  ...
  const [isGoogleSignupLoading, setIsGoogleSignupLoading] = useState<boolean>(false);
  const {
    register,
    handleSubmit,
    formState: { errors },
    ...
    >
      <div className='flex max-w-[400px] flex-1 flex-col gap-y-8'>
        ...
        <div className='flex flex-col gap-y-4'>
          ...
          <form onSubmit={handleSubmit(handleSignup)} className='flex flex-col gap-y-5'>
            ...
            <div className='flex flex-col gap-y-2'>
              ...
              <InputIcon
                id='confirmPassword'
                type={passwordsState.isShowConfirmPassword ? 'text' : 'password'}
